...
- dialog "Unhandled Runtime Error" [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e26]:
      ...
      - generic [ref=e28]:
        - link "app\\page.tsx (884:33) @ getCurrentWindow" [ref=e30] [cursor=pointer]:
          - generic [ref=e31]: app\page.tsx (884:33) @ getCurrentWindow
          - img [ref=e32]
        - generic [ref=e36]: 882 | 883 | // デバッグ：起動時ウィンドウ情報 > 884 | const win = getCurrentWindow(); | ^ 885 | console.log('[BOOT] label=', win.label, 'pathParam=', !!searchParams.get('path')); 886 | 887 | // pathパラメータが無い場合（管理画面/初回起動ルート）は必ずcheckSetupを実行
