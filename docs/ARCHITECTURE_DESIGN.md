...
|---|---|---|
| 1.0 | 2025年頃 | 初版作成 |
| 1.1 | 2025年頃 | オーケストレーター・パターンの明文化（別ファイル ARCHITECTURE_DESIGN_v1.1.md として作成） |
| 2.0 | 2026-04-08 | v1.1 を統合・最新化。Google Drive ファイル仕様・ライフサイクル表・VAPID鍵設計意図を追加。以降はこのファイルを唯一の設計書として更新する |
