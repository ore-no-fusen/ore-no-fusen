...
| 26-08-30 | 5.2.0 | STEP 2完了・申請待ち | 1,138秒（18分58秒）＋実機操作 | 5.1.5比592秒増加 | 版設定3、誤ったフロント単体ビルド301、exe作成337、Dev MSIX・導入16、Store MSIX 7、検証3、pre-commit・統合455、GitHub反映16 | 折りたたみ機能と匿名利用状況集計。古いexeをタイムスタンプで検出して正式Tauriビルドへ戻り、合格exeをStore用MSIXへ再利用 |
