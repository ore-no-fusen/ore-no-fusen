...
| 26-08-16 | 5.1.5 | Store提出物作成完了 | 261秒（4分21秒）＋実機操作 | 5.1.4比59秒短縮 | exe・Dev MSIX・導入253、Store MSIX 6、検証2 | 旧自動起動の再登録防止。合格済みexeをStore用MSIXへ再利用 |
...
| 26-08-16 | 5.1.5 | 2 | STEP 1・2成功 | - | 69 | - | - | 253（1-3〜1-4込み） | - | - | 成功 | 6 | 2 |  | 330+操作 | 共有`auto_start`をfalseへ移行。Dev実機・Store形式5項目・exe SHA-256一致を確認 |
