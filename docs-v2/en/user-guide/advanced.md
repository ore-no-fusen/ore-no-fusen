...
## Create reusable crystals

Use a note's context menu to create a Recipe, Q&A, or Term. New files use these names:

| Type | Example |
|---|---|
| Recipe | `Reci0001_2026-07-18_Name.md` |
| Q&A | `QA0001_2026-07-18_Name.md` |
| Term | `Term0001_2026-07-18_Name.md` |
