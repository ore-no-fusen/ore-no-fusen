...
[日本語](/user-guide/basic)

| Goal | Action |
|---|---|
| New note | `Ctrl+N` or the tray menu |
| Edit | Double-click a note |
| Finish editing | Click outside or press `Esc` |
| Search | `Ctrl+F` |
| Delete | Use the trash button on the right or right-click → Delete |
