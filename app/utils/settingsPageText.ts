...
const EN = {
    ...
    templates: {
        title: 'Recipe, Q&A, and Term Templates', description: 'Set section names, roles, and order for newly created crystals.', notice: 'Changes apply only to newly created recipes, Q&As, and terms. Existing content is not changed.', cardDescription: 'Set section names, roles, and order.', suffix: ' Template', loading: 'Loading templates...', loadFailed: 'The defaults are shown because the templates could not be loaded.', resetConfirmSuffix: ' template to its defaults?', resetDone: 'Defaults restored. Save to apply them.', emptyLabel: 'Section names cannot be empty.', moveUp: 'Move up', moveDown: 'Move down', fixed: 'Fixed section (name can be edited; section cannot be deleted)', fixedHelp: '🔒 Fixed section: its name can be edited, but the section itself cannot be deleted.', tracked: 'Track', trackHelp: '“Track”: when a crystal is returned, detect changes to this section and list its name in Improvement History. Turning it off does not discard content; its changes are simply not counted.', prerequisite: '+ Prerequisite', addFree: '+ Add Custom Section', reset: 'Restore Defaults', newSection: 'New Section', prerequisiteLabel: 'Prerequisite',
